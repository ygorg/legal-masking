#!/bin/bash
#SBATCH --job-name=le-base              # nom du job
#SBATCH --output=./job_out_err/run_training_baseline_legal_bert_%j.out          # nom du fichier de sortie
#SBATCH --error=./job_out_err/run_training_baseline_legal_bert_%j.err           # nom du fichier d'erreur (ici en commun avec la sortie)
