#!/bin/bash
#SBATCH --job-name=be-tf-to              # nom du job
#SBATCH --output=./job_out_err/run_training_tfidf_topn_%j.out          # nom du fichier de sortie
#SBATCH --error=./job_out_err/run_training_tfidf_topn_%j.err           # nom du fichier d'erreur (ici en commun avec la sortie)
