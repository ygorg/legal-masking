#!/bin/bash
#SBATCH --job-name=be-tf-ra              # nom du job
#SBATCH --output=./job_out_err/run_training_tfidf_weighted_random_%j.out          # nom du fichier de sortie
#SBATCH --error=./job_out_err/run_training_tfidf_weighted_random_%j.err           # nom du fichier d'erreur (ici en commun avec la sortie)
