#!/bin/bash
#SBATCH --job-name=le-tf-ra              # nom du job
#SBATCH --output=./job_out_err/run_training_tfidf_legal_bert_weighted_random_%j.out          # nom du fichier de sortie
#SBATCH --error=./job_out_err/run_training_tfidf_legal_bert_weighted_random_%j.err           # nom du fichier d'erreur (ici en commun avec la sortie)
