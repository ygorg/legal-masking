#!/bin/bash
#SBATCH --job-name=Lexglue-benchmark-LegalBERT-Random
#SBATCH --output=./job_out_err/run_evaluation_legalBERT_Random_%A_%a.out
#SBATCH --error=./job_out_err/run_evaluation_legalBERT_Random_%A_%a.err
